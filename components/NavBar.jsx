...
const NavBar = () => {
    ...
    return (
        <>
            ...
            <nav className="bg-red-100 px-2 sm:px-4 py-2.5 sticky w-full z-20 top-0 left-0 border-b border-gray-200">
                <div className="container flex flex-wrap justify-between items-center mx-auto">
                    <Link href="/" className="flex items-center text-black">
                        <ShoppingCartIcon className='w-9 h-9' />
                        <span className="self-center text-xl font-semibold whitespace-nowrap">XataStore</span>
                    </Link>
                    ...
                    <div className={`${toggle ? "justify-between items-center w-full md:flex md:w-auto md:order-1" : "hidden justify-between items-center w-full md:flex md:w-auto md:order-1"}`} id="navbar-sticky">
                        <ul className="flex flex-col p-4 mt-4 bg-red-100 rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-red-100">
                            <li>
